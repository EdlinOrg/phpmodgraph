<?php
/**
 * Modified version v.0.8.0 of the project PHPCallGraph
 * added format flag 'mod' for phpmodgraph
 * 
        ...
        if ($helpOption->value === true) {
            ...
            switch ($formatOption->value) {
                ...
                case 'txt':
                    ...
                    break;
                case 'mod':
                    // The driver for phpmodgraph
                    require_once 'drivers/GraphVizMarkModificationsDriver.php';
                    $driver = new GraphVizMarkModificationsDriver();
                    $driver->setOutputFormat('png');
